...
const registerAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, responseHandler_1.sendSuccessResponse)(res, 201, "Registration successful", newAdminData);
    }
    catch (error) {
...
const registerStaff = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, responseHandler_1.sendSuccessResponse)(res, 201, "Registration successful", newStaffData);
    }
    catch (error) {
