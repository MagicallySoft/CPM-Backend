...
router.get('/customer/remindproduct', authMiddleware_1.authenticateUser, (0, authMiddleware_1.authorizeRoles)('admin', "employee"), asyncHandler(customerController_1.getProductRenewals));
