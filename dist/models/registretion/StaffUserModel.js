...
// models/CombinedStaffUser.ts
const mongoose_1 = __importStar(require("mongoose"));
const bcryptjs_1 = __importDefault(require("bcryptjs"));
const StaffUserSchema = new mongoose_1.Schema({
...
StaffUserSchema.methods.incrementLoginAttempts = function () {
    return __awaiter(this, void 0, void 0, function* () {
        const updates = {
            $inc: { loginAttempts: 1 },
        };
...
const StaffUser = mongoose_1.default.model("StaffUser", StaffUserSchema);
