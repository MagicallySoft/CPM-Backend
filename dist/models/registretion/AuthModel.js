...
const AuthSchema = new mongoose_1.Schema({
    ...
    companyId: { type: mongoose_1.Schema.Types.ObjectId, ref: "AdminUser", required: true },
    permissions: {
...
// 🔹 Ensure that each company cannot have duplicate Auth names
AuthSchema.index({ companyId: 1, name: 1 }, { unique: true });
